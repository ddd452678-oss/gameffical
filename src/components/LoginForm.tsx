    ...
    <div className="mx-auto max-w-sm rounded-2xl bg-surface p-6 shadow-card">
      ...
      <div className="mt-6 space-y-2.5">
        ...
        <button
          ...
          className="flex h-12 w-full cursor-not-allowed items-center justify-center gap-2 rounded-xl border border-border bg-surface-2 text-sm font-bold text-text-dim"
        >
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        <div>
          <label htmlFor="login-username" className="text-sm text-text-dim">
            아이디
          </label>
          <input
            id="login-username"
            ...
            placeholder={mode === "signup" ? "영문/숫자/밑줄 4~20자" : "아이디"}
        ...
        {mode === "signup" && (
          <div>
            <label htmlFor="login-email" className="text-sm text-text-dim">
              이메일 <span className="text-xs">(비밀번호 찾기·아이디 찾기용)</span>
            </label>
            <input
              id="login-email"
              type="email"
        ...
        <div>
          <label htmlFor="login-password" className="text-sm text-text-dim">
            비밀번호 <span className="text-xs">(6자 이상)</span>
          </label>
          <input
            id="login-password"
            type="password"
